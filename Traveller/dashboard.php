  ...
  <div class="container page-wrap">
    <div class="sidebar-layout">
      ...
      <div>
        ...
        <div
          style="display:grid; grid-template-columns:repeat(auto-fill,minmax(180px,1fr)); gap:16px; margin-bottom:28px;">
        ...
        <div class="card">
                ...
                <tbody>
                  <?php foreach ($recentBookings as $b): ?>
                    <tr>
                      ...
                      <td><a href="/COS221-PA5/packages_detail.php?id=<?= $b['HolidayID'] ?>"
          ...
          <?php else: ?>
            <div class="card-body text-muted">No bookings yet. <a href="packages.php">Browse packages</a> to get started!
            </div>
          <?php endif; ?>
        </div>
