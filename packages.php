...
<div class="container page-wrap">
  <div class="sidebar-layout">
    ...
    <div>
      ...
      <div class="alert alert-info">Package added to compare. <a href="compare.php">View comparison →</a></div>
      <?php endif; ?>
        ...
        <div class="pack-card">
          ...
          <div class="pack-footer">
            ...
            <div style="display:flex; gap:6px">
              ...
              <a href="package_detail.php?id=<?= $pkg['PackID'] ?>" class="btn btn-primary btn-sm">View →</a>
            </div>
          </div>
        </div>
        <?php endforeach; ?>
