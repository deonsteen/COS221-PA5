...
<nav class="navbar">
  ...
  <div class="nav-links">
    <a href="/COS221-PA5/traveller/packages.php"     class="<?= $currentPage==='packages.php'     ? 'active':'' ?>">Packages</a>
    ...
    <a href="/COS221-PA5/traveller/profile.php"      class="<?= $currentPage==='profile.php'      ? 'active':'' ?>"><?= htmlspecialchars($u['username']) ?></a>
